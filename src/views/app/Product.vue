                ...
                <div class="widget">
                  ...
                  <div class="widget-body widget-newsletter">
                    <form action="#" class="input-wrapper input-wrapper-inline">
                      ...
                      <button
                        class="
                          btn btn-primary btn-sm btn-icon-right btn-rounded
                        "
                        type="submit"
                      >
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      ApiService.get(`products/related/${productId.value}/`)
        .then((response) => {
          relatedProductsList.value = response.data;
        })
        .catch((e) => {
          console.log(e);
        });

      ApiService.get(`comments/comments-product/${productId.value}/`)
        .then((response) => {

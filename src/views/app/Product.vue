<template>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <ul>
                          ...
                          <li><a href="element-floating.html">Floating </a></li>
                          <li><a href="element-hotspot.html">Hotspot </a></li>
                          <li>
                      ...
                      <div class="col-md-3">
                        ...
                        <ul>
                          ...
                          <li><a href="element-vendor.html">Vendor </a></li>
              ...
              <div class="dropdown-box">
                <div class="products scrollable">
                  <div class="product product-cart">
                    ...
                    <div class="product-detail">
                      <a href="demo7-product.html" class="product-name"
                ...
                <div class="col-lg-5">
                  <div class="product-details">
                    ...
                    <p class="product-short-desc">
                      ...
                      liberpuro ate vol faucibus adipiscing. Sed lectus te.
                    </p>
                    <div class="product-form product-color">
                      ...
                      <div class="product-variations">
                        <a
                          ...
                          href="#"
                          style="background-color: #d99e76"
                        ></a>
                        <a
                          class="color"
                          data-src="images/demos/demo7/products/2.jpg"
                          href="#"
                          style="background-color: #267497"
                        ></a>
                        <a
                          class="color"
                          data-src="images/demos/demo7/products/3.jpg"
                          href="#"
                          style="background-color: #9a999d"
                        ></a>
                        <a
                          class="color"
                                    ...
                                    <div class="comment-body">
                                      ...
                                      <div class="comment-content">
                                        <p>
                                          ...
                                          adipiscing, commodo quis, avida id,
                            ...
                            <div class="review-form-wrapper">
                              ...
                              <form action="#">
                                ...
                                <div class="review-medias">
                                  <div
                                    class="file-input form-control image-input"
                                    style="
                                  ...
                                  <div
                                    class="file-input form-control video-input"
                                    style="
                                      background-image: url(images/product/placeholder.png);
                                    "
                                  >
                ...
                >
                  <div class="product text-center">
                    ...
                    <div class="product-details">
                      ...
                      <h3 class="product-name">
                        <a href="demo7-product.html">Fashion Football Boots</a>
                      </h3>
                      ...
                      <div class="ratings-container">
                        ...
                        <a href="demo7-product.html" class="rating-reviews"
                          >( <span class="review-count">6</span> reviews )</a
                        >
                      </div>
                    </div>
                  </div>
                  <div class="product text-center">
                    ...
                    <div class="product-details">
                      ...
                      <h3 class="product-name">
                        <a href="demo7-product.html"
                          >Fashion White Training Shoes</a
                        >
                      </h3>
                      <div class="product-price">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="widget">
                <h4 class="widget-title text-normal">
                ...
                <div class="widget-body widget-newsletter">
                  <form action="#" class="input-wrapper input-wrapper-inline">
                    ...
                    />
                    <button
                      class="btn btn-primary btn-sm btn-icon-right btn-rounded"
                      type="submit"
                    >
  ...
  <div class="sticky-footer sticky-content fix-bottom">
    <a href="demo7.html" class="sticky-link">
      <i class="d-icon-home"></i>
      <span>Home</span>
    </a>
    <a href="demo7-shop.html" class="sticky-link">
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="shop-off-canvas-filter.html">Off-Canvas Filter </a>
                </li>
                <li><a href="shop-top-banner.html">Top Banner</a></li>
                <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="shop-category+products.html">Category + Products</a>
                </li>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li><a href="element-banner-effect.html">Banner Effect </a></li>
                <li><a href="element-banner.html">Banner </a></li>
            ...
            <li>
              ...
              <ul>
                ...
                <li><a href="element-animation.html">Entrance Effect </a></li>
                <li><a href="element-floating.html">Floating </a></li>
                <li><a href="element-hotspot.html">Hotspot </a></li>
                <li><a href="element-icon-boxes.html">Icon Boxes</a></li>
                <li><a href="element-icons.html">Icons</a></li>
                <li><a href="element-image-box.html">Image box </a></li>
            ...
            <li>
              ...
              <ul>
                ...
                <li><a href="element-product-tab.html">Products + Tab </a></li>
                <li>
            ...
            <li>
              <a href="#">Elements 4</a>
              <ul>
                <li><a href="element-subcategory.html">Subcategory </a></li>
                <li><a href="element-svg-floating.html">Svg Floating </a></li>
                <li><a href="element-tabs.html">Tabs</a></li>

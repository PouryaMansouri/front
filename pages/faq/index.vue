                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse1-1" class="collapse"
                        >How can add vendor role to the customer?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse1-2" class="expand"
                        >What benefits a customer can take?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse1-3" class="expand"
                        >How to change customer's address?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse2-1" class="collapse"
                        >What is difference between simple & variable
                        product?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse2-2" class="expand"
                        >How to buy several products at once?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse2-3" class="expand"
                        >How to add downloadable product?</a
                      >
                    </div>
            ...
            <div class="row">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse3-1" class="collapse"
                        >How can a guest order the product?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse3-2" class="expand"
                        >What kind of payment methods are available?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse3-3" class="expand"
                        >What is benefit of paypal payment?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse3-4" class="expand"
                        >How to register as a customer?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse3-5" class="expand"
                        >What is the preferable way to buy product?</a
                      >
                    </div>
              ...
              <div class="col-md-6 mt-10">
                ...
                >
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse4-1" class="collapse"
                        >How can I return an purchased item online?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse4-2" class="expand"
                        >How to add coupon code?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse4-3" class="expand"
                        >How can I find theme style?</a
                      >
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <a href="#collapse4-4" class="expand"
                        >What are the delivery types you can use?</a
                      >
                    </div>
